...
if  ( ! function_exists( 'thumbs_rating_getlink' ) ):
	...
	function thumbs_rating_getlink($post_ID = '', $type_of_vote = '')
	{
		...
		$link_up = '<span class="thumbs-rating-up'. ( (isset($thumbs_rating_up_count) && intval($thumbs_rating_up_count) > 0 ) ? ' thumbs-rating-voted' : '' ) .'" onclick="thumbs_rating_vote(' . $post_ID . ', 1);" data-text="' . __('Vote Up','thumbs-rating') . ' +"><span>' . $thumbs_rating_up_count . '</span></span>';
		$link_down = '<span class="thumbs-rating-down'. ( (isset($thumbs_rating_down_count) && intval($thumbs_rating_down_count) > 0 ) ? ' thumbs-rating-voted' : '' ) .'" onclick="thumbs_rating_vote(' . $post_ID . ', 2);" data-text="' . __('Vote Down','thumbs-rating') . ' -"><span>' . $thumbs_rating_down_count . '</span></span>';
